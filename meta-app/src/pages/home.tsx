...
export default function Home() {
    ...
    return (
        <div>
            <section className={"h-150 mobile:h-160 bg-black-gear overflow-hidden relative flex justify-center"}>
                ...
                <div className={"m-10 w-9/12 h-1/3"}>
                    <div className={"w-full"}>
                        ...
                        <div className={"mt-5 text-xs mobileS:text-sm text-gray-dark font-noto-sans break-keep"}>
            ...
            <section className={"content-container bg-white"}>
            ...
            <section className={"content-container bg-gray-light"}>
                <div className={"row-span-6 flex items-center"}>
                    <img className={"w-full rounded-xl"} src={"image/family2023.jpg"} alt={"2023 META family"}/>
                </div>
                <div className={"w-full row-span-6 flex flex-col gap-4"}>
                    ...
                    <a href={"https://google.com"} className={"external-link"}>바로 가기</a>
                </div>
            </section>
        </div>
    );
